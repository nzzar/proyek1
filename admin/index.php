...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost", "root", "", "db_guppybettamangga");
...
<div id="wrapper">
	<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; background-color:rgb(32,34,36);">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php" style="background: linear-gradient(135deg, #4FD3C4, #488FB1);">Admin GBM</a> 
		</div>
		<div style="color: white;
		padding: 15px 50px 5px 50px;
		float: right;
		font-size: 16px;"> &nbsp; <a href="index.php?halaman=logout" class="btn square-btn-adjust" style="background: linear-gradient(135deg, #4FD3C4, #488FB1); color: #ffff;">Logout</a> 
		</div>
	</nav>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li class="text-center">
						<img src="../img/cupanglogo.png" class="user-image img-responsive"/>
					</li>
					<li>
