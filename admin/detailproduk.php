...
$ambil = $koneksi->query("SELECT * FROM ikan LEFT JOIN kategori ON ikan.id_kategori=kategori.id_kategori WHERE id_ikan='$id_produk'");
$detailproduk = $ambil->fetch_assoc();

$fotoproduk = array();
$ambilfoto = $koneksi->query("SELECT * FROM produk_foto WHERE id_ikan='$id_produk'");
...
<table class="table">
  <tr>
    <th>Produk</th>
    <td><?= $detailproduk['nama_ikan']; ?></td>
  </tr>
  <tr>
    <th>Kategori</th>
    <td><?= $detailproduk['kategori_ikan']; ?></td>
  </tr>
  <tr>
    <th>Harga</th>
    <td>Rp. <?= number_format($detailproduk['harga_ikan']) ?>,-</td>
  </tr>
  <tr>
    <th>Deskripsi</th>
    <td><?= $detailproduk['deskripsi_ikan']; ?></td>
  </tr>
  <tr>
    <th>Stok</th>
    <td><?= $detailproduk['stok_ikan']; ?></td>
  </tr>
</table>
...
if(isset($_POST['simpan'])){
  ...
  $koneksi->query("INSERT INTO produk_foto(id_ikan, nama_produk_foto) VALUES('$id_produk', '$namafoto')");
