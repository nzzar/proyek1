		...
		<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<select name="id_kategori" id="" class="form-control">
						...
						<option value="<?= $value['id_kategori'] ?>"><?= $value['kategori_ikan']; ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="form-group">
...
if(isset($_POST["submit"])){
	...
	$result = $koneksi->query("INSERT INTO ikan VALUES('', '$_POST[id_kategori]', '$_POST[nama]', '$_POST[harga]', '$namanamafoto[0]', '$_POST[deskripsi]', '$_POST[stok]')");
	...
	foreach($namanamafoto as $key => $tiap_nama){
		...
		$hasil = $koneksi->query("INSERT INTO 	produk_foto(id_ikan, nama_produk_foto) VALUES('$id_produk_barusan','$tiap_nama')");
	}
